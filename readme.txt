...
With the Proweblook WA Validator plugin you can easily verify if a phone number is really exist on WA or not. (https://proweblook.com).

== Description ==

This plugin uses the Proweblook Wa-Validator API (https://proweblook.com) to check if a phone number is really exist on WA or not.
...
The Wa-Validator real-time validation API provides detailed information for each phone number:
...
1. ![Plugin Page](https://proweblook.com/blog/wp-content/uploads/2024/01/screenshotwa.png)
